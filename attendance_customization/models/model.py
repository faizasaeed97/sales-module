    ...
    def onchangesecond_checkin_checkout(self):
        for rec in self:
            ...
            if rec.second_check_in and rec.second_check_out:
                ...
                if check_prev:
                    if not check_prev.first_check_in and not check_prev.first_check_out:
                        check_prev.first_check_in == '08:00'  # -*- coding: utf-8 -*-
                    ...
                    if not check_prev.second_check_out:
                        if not check_prev.second_check_in:
                            ...
                            if not check_prev.first_check_out:
                                ...
                                check_prev.ot_125 = record.get_minute_hmformat(10 + 1 * 60)
                                check_prev.ot_15 = record.get_minute_hmformat(5 * 60)
                                ...
                                check_prev.ot_125 = record.get_minute_hmformat(10 * 60)
                                check_prev.ot_15 = record.get_minute_hmformat(5 * 60)

                                get_hrs = str(check_prev.get_schedule_ot(check_prev.employee_id, day)['ss'] / 60)

                                check_prev.second_shift_total_hours = str(get_hrs.split(".")[0] + ':' + get_hrs.split(".")[1])
                        else:
                            pass
